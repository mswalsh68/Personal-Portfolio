                ...
                return (
                      <div className="scoreboard" key={games.competitions[0].competitors[1].team.displayName}>
                        ...
                        <div className="scores away">
                          ...
                          #{games.competitions[0].competitors[1].curatedRank.current} {games.competitions[0].competitors[1].team.displayName}<br />
                        ...
                        <div className="scores at">
                          ...
                          TV : {games.competitions[0].broadcasts[0].names[0]} <br />
                          
                        </div>
                        
                        <div className="scores home">
                          <img src={games.competitions[0].competitors[0].team.logo}/><br />
                          #{games.competitions[0].competitors[0].curatedRank.current} {games.competitions[0].competitors[0].team.displayName}<br />
